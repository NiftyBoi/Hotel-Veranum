<DIV class="container-fluid bg-white mt-5">
        <div class="row">
            <div class="col-lg-4 p-4">
                <h3 class= "h-font fw-bold fs-3 mb-2"> </h3>
                <p>
            ...
            <div class="col-lg-4 p-4">
                    ...
                    <a href="facilities.php" class="d-inline-block mb-2 text-dark text-decoration-none">ESPECIFICACIONES</a> <br>
                    <a href="rooms.php" class="d-inline-block mb-2 text-dark text-decoration-none">HABITACIONES</a> <br>
                    <a href="restaurant.php" class="d-inline-block mb-2 text-dark text-decoration-none">RESTAURANT</a> <br>
                    <a href="contact.php" class="d-inline-block mb-2 text-dark text-decoration-none">CONTACTO </a> <br>
                    <a href="about.php" class="d-inline-block mb-2 text-dark text-decoration-none">ACERCA</a> <br>
            ...
            <div class="col-lg-4 p-4">
                        ...
                        <a href="#" class="d-inline-block text-dark text-decoration-none mb-2">
                            <i class="bi bi-twitter me-1"></i> Tuwiter
                        </a><br>
                        <a href="#" class="d-inline-block text-dark text-decoration-none mb-2">
                            <i class="bi bi-instagram me-1"></i> Insta
                        </a><br>
                        <a href="#" class="d-inline-block text-dark text-decoration-none mb-2">
                            <i class="bi bi-facebook me-1"></i> Feibu
                        </a><br>
            </div>
        </div>
    </DIV>
